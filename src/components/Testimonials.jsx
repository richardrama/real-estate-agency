...
const Testimonials = () => {
    return (
        <div className={`py-[50px] Service-1 flex flex-col items-center ${styles.boxWidth} mb-[50px]`}>
            <h1 className='max-w-[700px] text-center pb-[15px] text-[35px] font-[700]'>What's our users say about our services</h1>
            <ul className='grid grid-cols-3 gap-10'>
                <li className='pt-[20px] pb-[25px] px-[20px] bg-white rounded-[15px] box-shadow'>
                    ...
                    <p className='mt-[10px] text-[14px]'>
                        Very good app, I fount the properties that I've been searching for. What a great agency this company is.
